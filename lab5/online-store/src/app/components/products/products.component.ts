...
export class ProductsComponent {
  categories = ['дрон','планшет серый','планшет черный','сони','asus','iphone 16 pro max черный','iphone 16 pro max белый','iphone 16 pro max золотистый', 'iphone 16 pro max серебристый', 'macbookpro16.2'];
  selected = 'дрон';
  products = [
    {
      id:1,
